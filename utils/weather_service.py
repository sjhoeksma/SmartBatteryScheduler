...
class WeatherService:
    ...
    def get_timezone(self) -> str:
        ...
        if cache_key not in self._timezone_cache:
            ...
            self._timezone_cache[cache_key] = timezone_str or 'Europe/Amsterdam'
    ...
    def get_weather_data(self, timestamp: datetime) -> Dict:
        ...
        if cache_key in self._weather_cache:
            if datetime.now(pytz.UTC) - self._last_cache_time[cache_key] < self._cache_ttl:
    ...
    def location(self):
        ...
        return pvlib.location.Location(latitude=lat, longitude=lon, tz=timezone)